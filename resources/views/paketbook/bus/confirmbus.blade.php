                ...
                <fieldset>
                    ...
                    <div class="d-flex bd-highlight mt-4">
                        <div class="">
                            ...
                            <div>
                                <select class="form-select my-3" name="hari" data-harga="{{$bus->harga}}">
                            ...
                            <div>
                                <select class="form-select my-3" name="pesanan" data-harga="{{$bus->harga}}">
                        ...
                        <div class="col-lg-4">
                            <div class="card">
                                <div class="text-center ">
                                    ...
                                    <img src="{{asset('bus/' . $foto->foto)}}" class="rounded mt-3" width="300px">
                                    @endforeach
                                </div>
                                <div class="card-body">
                            ...
                            <table class="table table-borderless">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>{{'Rp. '.strrev(implode('.',str_split(strrev(strval($bus->harga)),3)))}}
                                        </td>
                                    </tr>
                                    <tr>
                ...
                <fieldset>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <input type="hidden" name="jumlah_rating" value="{{$bus->rating}}">
