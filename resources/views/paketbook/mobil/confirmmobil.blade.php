                ...
                <fieldset>
                    ...
                    <div class="d-flex bd-highlight mt-4">
                        <div class="">
                            ...
                            <div>
                                <select class="form-select my-3" name="hari" data-harga="{{$mobil->harga}}">
                            ...
                            <div>
                                <select class="form-select my-3" name="pesanan" data-harga="{{$mobil->harga}}">
                        ...
                        <div class="ml-auto ">
                            <h3>Harga Perhari</h3>
                            <h3>{{'Rp. '.strrev(implode('.',str_split(strrev(strval($mobil->harga)),3)))}}</h3>
                        </div>
                    </div>
                            ...
                            <table class="table table-borderless">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>{{'Rp. '.strrev(implode('.',str_split(strrev(strval($mobil->harga)),3)))}}
                                        </td>
                                    </tr>
                                    <tr>
                ...
                <fieldset>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <input type="hidden" name="jumlah_rating" value="{{$mobil->rating}}">
                            <input type="hidden" name="nama" value="{{$mobil->nama}}">
