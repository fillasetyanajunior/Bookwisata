                ...
                <fieldset>
                    ...
                    <div class="d-flex bd-highlight mt-4">
                        <div class="">
                            <h3>Bookwisata</h3>
                            @csrf
                            <input type="hidden" name="hidden" value="{{$hotel->user_id}}">
                            <div class="form-group">
                                <input type="date" class="form-control mt-3" name="date">
                            </div>
                            <div>
                                <select class="form-select my-3" name="hari" data-harga="{{$hotel->harga}}">
                            ...
                            <div>
                                <select class="form-select my-3" name="pesanan" data-harga="{{$hotel->harga}}">
                        ...
                        <div class="ml-auto ">
                            <h3>Harga Perhari</h3>
                            <h3>{{'Rp. '.strrev(implode('.',str_split(strrev(strval($hotel->harga)),3)))}}</h3>
                        </div>
                    </div>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <table class="table table-borderless">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><span id="jumlahpesanandetail"></span> Kamar/Room</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                    <hr size="10px">
                                    <table class="table table-borderless">
                                        <tbody>
                                            <tr>
                                                <td colspan="2">Tipe Kamar</td>
                                                <td>
                                                    @foreach ($tips as $tipe)
                            ...
                            <table class="table table-borderless">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>{{'Rp. '.strrev(implode('.',str_split(strrev(strval($hotel->harga)),3)))}}
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td colspan="2">Jumlah Pemesanan</td>
                                        <td><span id="jumlahpesanan"></span>  Kamar/Room</td>
                                    </tr>
                                    <tr>
                ...
                <fieldset>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <input type="hidden" name="jumlah_rating" value="{{$hotel->rating}}">
                            <input type="hidden" name="nama" value="{{$hotel->nama}}">
                            <input type="hidden" name="tipe" value="{{$hotel->tipe}}">
