                ...
                <fieldset>
                    ...
                    <div class="d-flex bd-highlight mt-4">
                        <div class="">
                            <h3>Bookwisata</h3>
                            @csrf
                            <input type="hidden" name="hidden" value="{{$paket->user_id}}">
                            <div class="form-group">
                                <input type="date" class="form-control mt-3" name="date">
                            </div>
                            <div>
                                <select class="form-select my-3" name="hari" data-harga="{{$paket->harga}}">
                            ...
                            <div>
                                <select class="form-select my-3" name="pesanan" data-harga="{{$paket->harga}}">
                        ...
                        <div class="ml-auto ">
                            <h3>Harga Perhari</h3>
                            <h3>{{'Rp. '.strrev(implode('.',str_split(strrev(strval($paket->harga)),3)))}}</h3>
                        </div>
                    </div>
                        ...
                        <div class="col-lg-4">
                            <div class="card">
                                <div class="text-center ">
                                    ...
                                    <img src="{{asset('paket/' . $foto->foto)}}" class="rounded mt-3" width="300px">
                                    @endforeach
                                </div>
                                <div class="card-body">
                                    <table class="table table-borderless">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><span id="jumlahpesanandetail"></span> Orang/Pax</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                    <hr size="10px">
                    ...
                    <div class="card mt-5">
                        ...
                        <div class="card-body">
                            <table class="table table-borderless">
                                ...
                                <tbody>
                                    <tr>
                                        <td colspan="2">Per Paket</td>
                                        <td>{{'Rp. '.strrev(implode('.',str_split(strrev(strval($paket->harga)),3)))}}
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td colspan="2">Jumlah Pemesanan</td>
                                        <td><span id="jumlahpesanan"></span>  Orang/Pax</td>
                                    </tr>
                                    <tr>
                ...
                <fieldset>
                    <div class="my-5">
                        ...
                        <p style="margin:0; border-top:2px solid #e5e5e5; font-size:5px; line-height:5px; margin:0 30px 10px;">
                            &nbsp;</p>
                        <p style="margin:0 30px 10px; text-align:center; text-transform:uppercase; font-size:18px; line-height:30px; font-weight:bold; color:#484a42;">
                            pakete Banking Permata
                        </p>
                        <p style="margin:0; border-top:2px solid #e5e5e5; font-size:5px; line-height:5px; margin:0 30px 20px;">
                            &nbsp;</p>
                        <ul class="pembayaran">
                            <li>Silahkan login pakete bangking yang dimiliki Permata Bank.</li>
                ...
                <fieldset>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <input type="hidden" name="jumlah_rating" value="{{$paket->rating}}">
