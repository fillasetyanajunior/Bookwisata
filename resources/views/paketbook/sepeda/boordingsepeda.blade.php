...
<div class="container col-xs-12 col-sm-6 col-md-8 my-5">
    ...
    <div class="card">
        <div class="card-body">
            ...
            <form action="/bordingsepeda" method="post">
                @csrf
                @php
                    $sepeda = DB::table('detail_riwayat')
                            ->join('sepeda','sepeda.nama','=','detail_riwayat.nama_pilihan')
                            ->limit('1')
                            ->where('sepeda.nama','=',$lasted->nama_pilihan)
