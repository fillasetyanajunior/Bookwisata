                ...
                <fieldset>
                    ...
                    <div class="d-flex bd-highlight mt-4">
                        <div class="">
                            ...
                            <div>
                                <select class="form-select my-3" name="hari" data-harga="{{$guide->harga}}">
                            ...
                            <div>
                                <select class="form-select my-3" name="pesanan" data-harga="{{$guide->harga}}">
                        ...
                        <div class="ml-auto ">
                            <h3>Harga Perhari</h3>
                            <h3>{{'Rp. '.strrev(implode('.',str_split(strrev(strval($guide->harga)),3)))}}</h3>
                        </div>
                    </div>
                        ...
                        <div class="col-lg-4">
                            <div class="card">
                                <div class="text-center ">
                                    ...
                                    <img src="{{asset('guide/' . $foto->foto)}}" class="rounded mt-3" width="300px">
                                    @endforeach
                                </div>
                                <div class="card-body">
                    ...
                    <div class="card mt-5">
                        ...
                        <div class="card-body">
                            <table class="table table-borderless">
                                ...
                                <tbody>
                                    <tr>
                                        <td colspan="2">Per Hari</td>
                                        <td>{{'Rp. '.strrev(implode('.',str_split(strrev(strval($guide->harga)),3)))}}
                                        </td>
                                    </tr>
                                    <tr>
