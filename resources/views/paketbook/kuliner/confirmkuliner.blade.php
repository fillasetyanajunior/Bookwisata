                ...
                <fieldset>
                    ...
                    <div class="d-flex bd-highlight mt-4">
                        <div class="">
                            <h3>Bookwisata</h3>
                            @csrf
                            <input type="hidden" name="hidden" value="{{$kuliner->user_id}}">
                            <div class="form-group">
                                <input type="date" class="form-control mt-3" name="date">
                            </div>
                            <div>
                                <select class="form-select my-3" name="hari" data-harga="{{$kuliner->harga}}">
                            ...
                            <div>
                                <select class="form-select my-3" name="pesanan" data-harga="{{$kuliner->harga}}">
                        ...
                        <div class="ml-auto ">
                            <h3>Harga Perhari</h3>
                            <h3>{{'Rp. '.strrev(implode('.',str_split(strrev(strval($kuliner->harga)),3)))}}</h3>
                        </div>
                    </div>
                            ...
                            <table class="table table-borderless">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>{{'Rp. '.strrev(implode('.',str_split(strrev(strval($kuliner->harga)),3)))}}
                                        </td>
                                    </tr>
                                    <tr>
