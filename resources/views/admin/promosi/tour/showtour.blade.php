...
<div class="content-wrapper">
    ...
    <div class="d-flex justify-content-center">
        <div class="col-sm-11 mx-4">
            ...
            @endif
            <button type="button" class="btn btn-primary my-3" id="addtour" data-toggle="modal"
            ...
            <table class="table bg-info ">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <button type="button" class="btn btn-warning" id="edittour" data-id="{{$Tour->id}}"
                                data-toggle="modal" data-target="#TourModal">
                                Edit
                            </button>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="TourModalLabel">Modal title</h5>
            ...
            <div class="body_tour">
                <form action="" method="POST" enctype="multipart/form-data">
                    <div class="modal-body">
                        ...
                        <div class="col mb-3">
                            ...
                            <select class="form-select form-control  @error('tipe') is-invalid @enderror"
                                ...
                                <option value="61">Bundling</option>
                                <option value="62">Non Bundling</option>
                            </select>
                        </div>
                        <div class="mb-3">
                    ...
                    <div class="modal-footer footer_tour">
