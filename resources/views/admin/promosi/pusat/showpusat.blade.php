...
<div class="content-wrapper">
    ...
    <div class="d-flex justify-content-center">
        <div class="col-sm-11 mx-4">
            ...
            @endif
            <button type="button" class="btn btn-primary my-3" id="addpusat" data-toggle="modal"
                data-target="#PusatModal">
                Tambah {{$title}}
            </button>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <form action="/pusat/delete/{{$Pusat->id}}" method="post" class="d-inline">
                                @method('delete')
                                @csrf
...
<div class="modal fade" id="PusatModal" tabindex="-1" aria-labelledby="PusatModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="PusatModalLabel">Modal title</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="body_pusat">
                <form action="" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="modal-footer footer_pusat">
