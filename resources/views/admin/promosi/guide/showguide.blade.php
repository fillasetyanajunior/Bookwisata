    ...
    <div class="d-flex justify-content-center">
        <div class="col-sm-11 mx-4">
          ...
          @endif
            ...
            <a href="{{route('create_guide')}}" class="btn btn-primary my-3">Tambah {{$title}}</a>
            <table class="table bg-info ">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{$Guide->alamat }} </td>
                        <td>
                            <a class="btn btn-warning" href="/guide/{{$Guide->id}}">Edit</a>
                            <form action="/guide/{{$Guide->id}}" method="post" class="d-inline">
                                @method('delete')
                                @csrf
