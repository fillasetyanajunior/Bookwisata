...
<div class="content-wrapper">
    ...
    <div class="d-flex justify-content-center">
        <div class="col-sm-11 mx-4">
            ...
            @endif
            <button type="button" class="btn btn-primary my-3" data-toggle="modal" id="addguide"
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <form action="/guide/delete/{{$Guide->id}}" method="post" class="d-inline">
                                @method('delete')
                                @csrf
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="GuideModalLabel">Modal title</h5>
            ...
            <div class="body_guide">
                <form action="" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="modal-footer footer_guide">
