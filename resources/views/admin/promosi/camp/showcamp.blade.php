...
<div class="content-wrapper">
    ...
    <div class="d-flex justify-content-center">
        ...
        @endif
            ...
            <a href="{{route('create_camp')}}" class="btn btn-primary my-3">Tambah {{$title}}</a>
            <table class="table bg-info ">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a class="btn btn-warning" href="/camp/{{$Camp->id}}">Edit</a>
                            <form action="/camp/{{$Camp->id}}" method="post" class="d-inline">
                                @method('delete')
                                @csrf
