...
<div class="content-wrapper">
    ...
    <div class="d-flex justify-content-center">
        <div class="col-sm-11 mx-4">
            ...
            @endif
            <button type="button" class="btn btn-primary my-3" id="addmobil" data-toggle="modal"
                data-target="#MobilModal">
                Tambah {{$title}}
            </button>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="MobilModalLabel">Modal title</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="body_mobil">
                <form action="" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="modal-footer footer_mobil">
