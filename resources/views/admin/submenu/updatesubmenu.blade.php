                ...
                <div class="mb-3">
                    ...
                    <select class="form-select form-control" aria-label="Default select example" id="menu" name="menu_id">
                        ...
                        @foreach ($menu as $item)
                            <option value="{{$item->id}}" @if($item->id == $subMenu->menu_id) selected @endif>{{$item->menu}}</option>
                        @endforeach
                    </select>
                </div>
                <div class="mb-3">
                    <label for="sub_menu" class="form-label">Nama Sub Menu</label>
                    <input type="text" class="form-control" id="sub_menu" name="sub_menu" value="{{$subMenu->sub_menu}} ">
                </div>
                <div class="mb-3">
