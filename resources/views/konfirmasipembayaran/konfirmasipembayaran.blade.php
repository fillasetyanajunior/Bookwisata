                ...
                <div class="col-sm-11 mx-4">
                    <form action="{{route('store_konfirmasi_pembayaran')}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('qr_kode') is-invalid @enderror" id="qr_kode"
                                name="qr_kode" placeholder="Kode Pesanan" value="{{old('qr_kode')}}">
                        </div>
                        <div class="mb-3">
                            <label for="formFile" class="form-label">File Konfrimasi</label>
                            <input class="form-control  @error('filekonfirmasi') is-invalid @enderror" type="file"
                                id="formFile" name="filekonfirmasi">
                        </div>
                        <div class="mb-3">
