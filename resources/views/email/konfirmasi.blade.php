                                ...
                                <td>
                                    ...
                                    <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                        <tbody>
                                            ...
                                            <tr>
                                                <td width="4" height="4"
                                                    style="background:url({{url("assets//email/shadow-left-top.png")}}) no-repeat 100% 0;">
                                                    <p style="margin:0; font-size:1px; line-height:1px;">&nbsp;</p>
                                                </td>
                                                <td colspan="3" rowspan="3" bgcolor="#f0f2ea" style="padding:0 0 30px;">
                                                    <!-- begin content -->
                                                    <img src="{{url('assets/utama/testmonial/bg1.jpg')}}" width="600"
                                                        height="400" alt="summer‘s coming trimm your sheeps"
                                                    ...
                                                    <p
                                                        style="margin:0 30px 33px; text-align:left; text-transform:capitalize; font-size:20px; line-height:30px; font-weight:bold; color:#484a42;">
                                                    ...
                                                    <p
                                                        ...
                                                        Berikut adalah detail pesanan anda. Silahkan melakukan
                                                        pembayaran sebelum time limite berakhir.
                                                    </p>
                                                    <p
                                                        style="margin:0 30px 20px; text-align:left; text-transform:capitalize; font-size:14px; color:#484a42;">
                                                        Bank Transfer :
                                                    </p>
                                                    <p
                                                        style="margin:0 30px 10px; text-align:left; text-transform:capitalize; font-size:14px; color:#484a42;">
                                                    ...
                                                    <br>
                                                    <table
                                                        style="margin:0 30px 33px; width: 90%;margin-bottom: 1rem;color: #212529; border-collapse: collapse;">
                                                        <tbody>
                                                            <tr>
                                                                <td
                                                                    style="padding: 0.75rem;vertical-align: top;border-top: 1px solid #dee2e6;">
                                                                    <p style="font-size:16px; color:#333333; ">Kode
                                                                        Pemesanan</p>
                                                                </td>
                                                                <td
                                                                    style="padding: 0.75rem;vertical-align: top;border-top: 1px solid #dee2e6;">
                                                            ...
                                                            <tr>
                                                                <td
                                                                    style="padding: 0.75rem;vertical-align: top;border-top: 1px solid #dee2e6;">
                                                                    <p style="font-size:16px; color:#333333; ">Nama
                                                                        Produk</p>
                                                                </td>
                                                                <td
                                                                    style="padding: 0.75rem;vertical-align: top;border-top: 1px solid #dee2e6;">
                                                            ...
                                                            <tr>
                                                                <td
                                                                    style="padding: 0.75rem;vertical-align: top;border-top: 1px solid #dee2e6;">
                                                                    <p style="font-size:16px; color:#333333; ">Tanggal
                                                                    </p>
                                                                </td>
                                                                <td
                                                                    style="padding: 0.75rem;vertical-align: top;border-top: 1px solid #dee2e6;">
                                                                    <p style="font-size:16px; color:#333333;">
                                                                        {{date('d-F-Y',strtotime($tanggal))}}</p>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td
                                                                    style="padding: 0.75rem;vertical-align: top;border-top: 1px solid #dee2e6;">
                                                                    <p style="font-size:16px; color:#333333; ">Nomer Hp
                                                                    </p>
                                                                </td>
                                                                <td
                                                                    style="padding: 0.75rem;vertical-align: top;border-top: 1px solid #dee2e6;">
                                                                    <p style="font-size:16px; color:#333333;">{{$nomer}}
                                                                    </p>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                ...
                                                                <td
                                                                    style="padding: 0.75rem;vertical-align: top;border-top: 1px solid #dee2e6;">
                                                                    <p style="font-size:16px; color:#333333;">{{$email}}
                                                                    </p>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td
                                                                    style="padding: 0.75rem;vertical-align: top;border-top: 1px solid #dee2e6;">
                                                                    <p style="font-size:16px; color:#333333; ">Total
                                                                        Pembayaran</p>
                                                                </td>
                                                                <td
                                                                    style="padding: 0.75rem;vertical-align: top;border-top: 1px solid #dee2e6;">
                                                                    <p style="font-size:16px; color:#333333;">
                                                                        {{'Rp. '.strrev(implode('.',str_split(strrev(strval($harga)),3)))}}
                                                                    </p>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td
                                                                    style="padding: 0.75rem;vertical-align: top;border-top: 1px solid #dee2e6;">
                                                                    <p style="font-size:16px; color:#333333; ">Status
                                                                        Pembayaran</p>
                                                                </td>
                                                                <td
                                                                    style="padding: 0.75rem;vertical-align: top;border-top: 1px solid #dee2e6;">
                                                                    <p style="font-size:16px; color:#333333;">Waiting
                                                                        Payment</p>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td
                                                                    style="padding: 0.75rem;vertical-align: top;border-top: 1px solid #dee2e6;">
                                                                    <p style="font-size:16px; color:#333333; ">Batas
                                                                        Pembayaran</p>
                                                                </td>
                                                                <td
                                                                    style="padding: 0.75rem;vertical-align: top;border-top: 1px solid #dee2e6;">
                                                                    <p style="font-size:16px; color:#333333;">
                                                                        {{date('d-F-Y H:i:s', strtotime($waktupayment))}}
                                                                    </p>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td
                                                                    style="padding: 0.75rem;vertical-align: top;border-top: 1px solid #dee2e6;">
                                                                    <p style="font-size:16px; color:#333333; ">
                                                                        Note/Programme Detail</p>
                                                                </td>
                                                                <td
                                                                    style="padding: 0.75rem;vertical-align: top;border-top: 1px solid #dee2e6;">
                                                                    <p style="font-size:16px; color:#333333;">{{$note}}
                                                                    </p>
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                                    ...
                                                    <p
                                                        style="margin:0 30px 33px; text-align:left; text-transform:capitalize; font-size:14px; line-height:30px; color:#484a42;">
                                                        Setalah melakukan pembayaran segera kirim konfirmasi pembayaran
                                                        di dashboard konfirmasi.
                                                    </p>
                                                    <p
                                                        style="margin:0; border-top:2px solid #e5e5e5; font-size:5px; line-height:5px; margin:0 30px 29px;">
                                                        &nbsp;</p>
                                                    <p
                                                        style="margin:0 30px 33px; text-align:center; text-transform:uppercase; font-size:24px; line-height:30px; font-weight:bold; color:#484a42;">
                                                        Metode Pembayaran
                                                    ...
                                                    <ul
                                                        ...
                                                        <li>Silahkan pilih menu Transaksi Lainnya. Setelah itu Klik menu
                                                            Transfer lalu klik menu Rek NSB lain Permata.</li>
                                                        <li>Masukan nomer rekening dengan nomer Virtual Account Anda
                                                            (8545580000530237) dan pilih Benar.</li>
                                                        <li>Masukan Jumlah nominal yang ingin anda transfer. Setalah itu
                                                            Pilih Benar.</li>
                                                        <li>Lalu pilih rekening Tunggu Sebentar hingga muncul konfirmasi
                                                            pembayaran. Kemudian pilih Ya.</li>
                                                    </ul>
                                                    <p
                                                        style="margin:0; border-top:2px solid #e5e5e5; font-size:5px; line-height:5px; margin:0 30px 10px;">
                                                        &nbsp;</p>
                                                    ...
                                                    <ul
                                                        style="font-family: 'Times New Roman', Times, serif; font-size: 18px">
                                                        <li>Silahkan login internet bangking kemudian pilih Menu
                                                            Pembayaran.</li>
                                                        <li>Lalu pilih sub menu Pembayaran Tagihan dan klik Virtual
                                                            Account</li>
                                                        <li>Silahkan pilih rekening anda lalu masukan nomer rekening
                                                            dengan nomer Virtual Account (8545580000530237) lalu klik
                                                            Lanjut.</li>
                                                        <li>Masukan Jumlah nominal yang ingin anda transfer. Kemudian
                                                            klik Submit.</li>
                                                        <li>Tunggu sebentar hingga anda memperoleh SMS notifikasi yang
                                                            berisi sebuah Kode. Setelah itu masukkan Kode tersebut.</li>
                                                    ...
                                                    <ul
                                                        style="font-family: 'Times New Roman', Times, serif; font-size: 18px">
                                                        <li>Silahkan login mobile bangking yang dimiliki Permata Bank.
                                                        </li>
                                                        <li>Lalu klik Menu Pembayaran Tagihan dan pilih Menu Virtual
                                                            Account.</li>
                                                        <li>Kemudian pilih Tagihan Anda dan pilih Daftar Tgihan Baru.
                                                        </li>
                                                        <li>Masukan nomer rekening dengan nomer Virtual Account Anda
                                                            (8545580000530237) sebagai Nomer Tagihan. Apabila selesai
                                                            silahkan klik Konfirmasi.</li>
                                                        <li>Masukan Nama Pengingat setelah itu klik Lanjut. Apabila
                                                            selesai silahkan klik Konfirmasi.</li>
                                                        <li>Kemudian masukan Jumlah nominal yang ingin anda transfer.
                                                            Apabila selesai silahkan klik Konfirmasi.</li>
                                                        <li>Masukan Response Code dan klik Konfirmasi apabilatelah
                                                            selesai</li>
                                                    ...
                                                    <ul
                                                        ...
                                                        <li>Pilih menu TRANSFER > TRANSFER KE BANK LAIN > TRANSFER
                                                            ONLINE.</li>
                                                        <li>Masukan kode Bank Permata : <b>013</b></li>
                                                        <li>Masukan nomer Virtual Account Anda (8545580000530237) pada
                                                            kolom nomer rekening tujuan.</li>
                                                        <li>Kemudian masukan Jumlah nominal yang ingin anda transfer
                                                        </li>
                                                            ...
                                                            <tr valign="top">
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <p
                                                                        ...
                                                                        Help &amp; customer support: +62 274 - 443165 |
                                                                        WA. +62 81 5791 3168 | E:
                                                                        info@bookwisata.com<br>
                                                                        Website: <a href="{{url('/')}}"
